...
namespace HospitalAppoimentSolution.Helper.Core
{
    ...
    {
        public static List<DayLst> getLstDay()
        {
            List<DayLst> days = new List<DayLst>();
            days.Add(new DayLst { ID = 1, Name = "Thứ Hai" });
            days.Add(new DayLst { ID = 2, Name = "Thứ Ba" });
            days.Add(new DayLst { ID = 3, Name = "Thứ Tư" });
            days.Add(new DayLst { ID = 4, Name = "Thứ Năm" });
            days.Add(new DayLst { ID = 5, Name = "Thứ Sáu" });
            days.Add(new DayLst { ID = 6, Name = "Thứ Bảy" });
            days.Add(new DayLst { ID = 0, Name = "Chủ Nhật" });
            return days;
        }
    }
}
